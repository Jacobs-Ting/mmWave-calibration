...
st.set_page_config(page_title="Global Beam Scan & Auto-Rescue", layout="wide")
st.title("🌐 System-Level Verification: Global Beam Scan & Worst-Case Auto-Rescue")
...
# [修復] 將 get_mask 函數補回，並放在 evaluate_fitness 之前
